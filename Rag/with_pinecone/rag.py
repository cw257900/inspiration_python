...
print(f"text_madel: SentenceTransformer/paraphrase-MiniLM-L6-v2")
print(f"image_model: openai/clip-vit-base-patch32")
print(f"image_processor: openai/clip-vit-base-patch32")
...
def main(pdf_file_path, embed_text=True, embed_table=False, embed_image=False):
    ...
    print(f"3. Start upload embedding to vector DB")
    upload_embeddings(
